      ...
      <div class="row">
        ...
        <div class="col-xxl-3 col-xl-12">
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Suppliers <span>| Total</span></h5>
        ...
        <div class="col-xxl-3 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Purchase <span>| Today({{$purchase}})</span></h5>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6>{{$monthlypurchase}}</h6>
                  <span class="text-muted small pt-2 ps-1">Total:</span><span class="text-danger small pt-1 fw-bold">{{$totalpurchase}}</span> 
                </div>
              </div>
            </div>
        ...
        <div class="col-xxl-3 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Sales <span>| Today({{$sale}})</span></h5>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6>{{$monthlysale}}</h6>
                  <span class="text-muted small pt-2 ps-1">Total:</span><span class="text-danger small pt-1 fw-bold">{{$totalsale}}</span>
                </div>
              </div>
            </div>
