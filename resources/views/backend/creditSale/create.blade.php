...
@section('page-subtitle', 'Credit Sale Create')
@section('content')
    <style>
        .form-control {
            height: 35px;
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="bs-stepper-content">
                    <form action="{{ route('creditsale.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="text" name="trn_no" id="" class="form-control"
                                    style="height:30px;">
                                @error('trn_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
