...
@section('page-subtitle', 'Sale Return')
@section('content')
    <style>
        thead tr th {
        ...
        <div class="card">
            <div class="card-body">
                <div class="bs-stepper-content">
                    <form action="{{ route('salesReturnStore', $sale->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="customer_id" id="" value="{{$sale->customer->customer_name}}" class="form-control" aria-label="Username" aria-describedby="basic-addon1" readonly>
                                    @error('customer_id')
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="contact_no" id="contact"
                                        ...
                                        aria-label="Username" aria-describedby="basic-addon1" required readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="invoice_no" id=""
                                        value="{{ old('invoice_no', $sale->invoice_no) }}" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="reason" id=""
                                        value="{{ old('reason', $sale->reason) }}" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">Date<span
                                            class="star">*</span></span>
                                    <input type="date" name="return_date" id="current_date"
                                        value="{{ old('return_date', $sale->return_date) }}" class="form-control" aria-label="Username"
                                        ...
                                        @foreach ($saledetail as $sdetail)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                    <input type="text" name="" id="" value="{{$sdetail->product->product_name}}-{{$sdetail->product->oem}}-{{$sdetail->product->origin}}" class="form-control" aria-label="Username" aria-describedby="basic-addon1" readonly>

                                                    <input type="hidden" name="product_id[]" id="" value="{{$sdetail->product->id}}" class="form-control" aria-label="Username" aria-describedby="basic-addon1" readonly>
