                    ...
                    <form action="{{ route('creditpurchase.update',encryptor('encrypt',$creditPurchase->id)) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mt-2">
                                ...
                                <select class="select2 form-select" name="supplier_id">
                                    ...
                                    @foreach ($supplier as $value)
                                        <option value="{{ $value->id }}" {{ old('supplier_id',$creditPurchase->supplier_id==$value->id?"selected":"") }}>{{ $value->supplier_name }}</option>
                                    @endforeach
                                </select>
                                @error('supplier_id')
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="text" name="tm_no" value="{{old('tm_no',$creditPurchase->tm_no)}}" id="" class="form-control"
                                    style="height:30px;">
                                @error('tm_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="text" name="invoice_no" value="{{old('invoice_no',$creditPurchase->invoice_no)}}" id="" class="form-control"
                                    style="height:30px;">
                                @error('invoice_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="text" name="rf_no" value="{{old('rf_no',$creditPurchase->rf_no)}}" id="" class="form-control"
                                    style="height:30px;">
                                @error('rf_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="text" name="explanation" value="{{old('explanation',$creditPurchase->explanation)}}" id="" class="form-control"
                                    style="height:30px;">
                                @error('explanation')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="date" name="date" value="{{old('date',$creditPurchase->date)}}" id="current_date" class="form-control"
                                    style="height:30px;">
                                @error('date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-6 mt-2">
                                ...
                                <input type="text" name="total_quantity" value="{{old('total_quantity',$creditPurchase->total_quantity)}}" id="" class="form-control"
                                    style="height:30px;">
                            </div>
                            <div class="col-sm-6 mt-2">
                                <label for="">Total Before Vat</label>
                                <input type="text" name="total_before_vat" value="{{old('total_before_vat',$creditPurchase->total_before_vat)}}" id="" class="form-control"
                                    style="height:30px;">
                            </div>
                            <div class="col-sm-6 mt-2">
                                <label for="">Total Tax(5%)</label>
                                <input type="text" name="total_tax" value="{{old('total_tax',$creditPurchase->total_tax)}}" id="" class="form-control"
                                    style="height:30px;">
                            </div>
                            <div class="col-sm-6 mt-2">
                                <label for="">Total After Vat</label>
                                <input type="text" name="total_after_vat" value="{{old('total_after_vat',$creditPurchase->total_after_vat)}}"  id="" class="form-control"
                                    style="height:30px;">
                            </div>
                            <div class="col-sm-6 mt-2">
                            ...
                            <div class="col-sm-6 mt-2 d-flex">
                                ...
                                <select name="credit_cash" id="credit_cash" class="form-control"
                                    ...
                                    <option value="1" @if(old('credit_cash',$creditPurchase->credit_cash)==1) selected @endif>Credit</option>
                            ...
                            <div class="col-sm-6 mt-2 d-flex">
                                ...
                                <select name="status" id="status" class="form-control"
                                    style="width:100%; height:35px">
                                    <option value="1" @if(old('status',$creditPurchase->status)==1) selected @endif>Unpaid</option>
