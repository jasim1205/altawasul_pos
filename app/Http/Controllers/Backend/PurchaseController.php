...
class PurchaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $purchase = Purchase::with('purchaseDetails')->latest()->paginate(20);
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (is_numeric($request->supplier_id)) {
                ...
                $supplier->trn_no = $request->tm_no;   // if you have contact field
                $supplier->save();
...
public function update(Request $request, $id)
{
    ...
    public function PurchaseReport(Request $request)
    {
        ...
        $pdf = PDF::loadView('backend.purchase.purchasepdf', compact('purchase', 'fromDate', 'toDate'));
